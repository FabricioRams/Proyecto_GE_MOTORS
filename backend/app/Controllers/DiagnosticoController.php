...
class DiagnosticoController
{
    ...
    public static function create(): void
    {
        ...
        try {
            // PROCESAMIENTO OBD-II: Convertir tramas RAW a códigos legibles
            $obdService = new OBDService();
            $codigosFalla = $obdService->parsearTramaHex($tramasHex);
            ...
            // Actualizar la orden: aprobamos presupuesto para cumplir RN-04
            // y avanzamos al estado de reparación.
            $orden->update(['presupuesto_aprobado' => true]);
            $orden->cambiarEstado('reparacion');
            
            NotificacionService::notificarCambioEstado($orden->id, 'reparacion');
